...
try { db.exec(`ALTER TABLE cash_register ADD COLUMN given_to_owner REAL;`); } catch (e) {}
try { db.exec(`ALTER TABLE cash_register ADD COLUMN given_by INTEGER REFERENCES users(id) ON DELETE SET NULL;`); } catch (e) {}
try { db.exec(`ALTER TABLE cash_register ADD COLUMN given_at DATETIME;`); } catch (e) {}
try { db.exec(`ALTER TABLE branches ADD COLUMN gst_enabled INTEGER NOT NULL DEFAULT 1;`); } catch (e) {}
module.exports = db;